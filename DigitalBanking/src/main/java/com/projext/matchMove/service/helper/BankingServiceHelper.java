package com.projext.matchMove.service.helper;

import com.projext.matchMove.domain.*;
import com.projext.matchMove.model.*;
...
public class BankingServiceHelper {
	...
	public AddressDetails convertToAddressDomain(Address address) {
		...
		return AddressDetails.builder().address(address.getAddress())
	...
	public Address convertToAddressEntity(AddressDetails addressDetails) {
		...
		return Address.builder().address(addressDetails.getAddress())
